...
import css from "./SidepanelContainer.less";
 ...
 */
class SidepanelContainerWrapped extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div
        ...
        className={classNames(css.SidepanelContainer, className, { open })}
        style={{ width }}
      >
        <div
          className="toggle"
...
export default React.forwardRef(function SidepanelContainer(props, ref) {
  return <SidepanelContainerWrapped {...props} forwardedRef={ref} />;
});
