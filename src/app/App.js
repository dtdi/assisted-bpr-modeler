...
import { assign, debounce, forEach, isString, reduce } from "min-dash";
...
export class App extends PureComponent {
  ...
  triggerAction = failSafe((action, options) => {
    ...
    if (action === "create-simubpmn-diagram") {
      return this.createDiagram("simubpmn");
    }
    ...
    if (action === "log") {
      const { action, category, message } = options;
