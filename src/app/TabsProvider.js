...
import simubpmnPackage from "./tabs/simubpmn/models/service_request_collab.simubpmn";
...
import { Flags, generateId } from "../util";
    ...
    this.providers = {
      ...
      simubpmn: {
        ...
        getComponent(options) {
          ...
          return import("./tabs/simubpmn");
        },
        getInitialContents(options) {
          return simubpmnPackage;
        },
        getHelpMenu() {
          return [
            {
              label: "Simulated BPMN",
              action: "https://camunda.org/bpmn/tutorial/",
            },
          ];
        },
        getNewFileMenu() {
          // Choosing "N" as recommended by Maxi Gollart
          return [
            {
              label: "Simulated BPMN Diagram",
              accelerator: "CommandOrControl+N",
              action: "create-simubpmn-diagram",
            },
          ];
        },
      },
