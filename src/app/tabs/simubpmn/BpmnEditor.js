...
import { Button, DropdownButton, Icon } from "../../../shared/ui";
...
import RedesignContainer from "./RedesignContainer";

import BsimBpmnModeler from "./modeler";
...
export class BpmnEditor extends CachedComponent {
  constructor(props) {
    ...
    this.redesignPanelRef = React.createRef();
    this.simuRef = React.createRef();
  ...
  async componentDidMount() {
    ...
    const redesignPanel = modeler.get("redesignPanel");
  ...
  handleNamespace = async (xml) => {
    ...
    //const simuUsed = findNamespaceUsages(xml, NAMESPACE_BSIM.uri);
  ...
  handleChanged = () => {
    ...
    const recommender = modeler.get("recommender");
  ...
  handleFocusDimension = (dimension) => {
    this.triggerAction("setFocus", dimension);
  };
  ...
  static createCachedState(props) {
    ...
    const modeler = new BsimBpmnModeler({
      ...options,
      position: "absolute",
    });
