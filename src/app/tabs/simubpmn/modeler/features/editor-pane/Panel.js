...
import SimulationConfigurationModal from "./SimulationConfigurationModal";
  ...
  render() {
    ...
    return (
      <Customizer settings={{ theme }}>
        ...
        >
          ...
          >
            <Pivot selectedKey={tab} onLinkClick={this.switchPivot} headersOnly>
              ...
              <PivotItem
                headerText="HISTORY"
                itemCount={redesignStack?._stack?.length}
                itemKey={"history"}
              />
            </Pivot>
            {tab === "ideas" && !context && (
        ...
        <SimulationConfigurationModal
          isOpen={isConfigModalVisible}
          onAction={onAction}
          bsim={this.state.definitions}
